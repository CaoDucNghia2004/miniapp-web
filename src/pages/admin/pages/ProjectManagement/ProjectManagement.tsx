        ...
        <Space>
          ...
          <Select
            ...
            options={[
              ...
              { label: '⏳ ' + getProjectStatusLabel('PENDING'), value: 'PENDING' },
              { label: '🚧 ' + getProjectStatusLabel('IN_PROGRESS'), value: 'IN_PROGRESS' },
              { label: '✅ ' + getProjectStatusLabel('COMPLETED'), value: 'COMPLETED' },
              { label: '❌ ' + getProjectStatusLabel('CANCELLED'), value: 'CANCELLED' }
            ]}
          />
          <Button
            type='primary'
